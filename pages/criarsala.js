        ...
        <Fragment>
            ...
            <div className="criarSalaContainer">
                {view === 0 ?
                    ...
                    : null}
                <div className="baralhoTotal">
                    {view === 1

                        ? <div>

                            <div className="tituloCriarSala2">
                                <h1 className="criarSala" >Criar Sala</h1>
                            </div>
                            <div className="tituloNomeSala">
                                <h1>Nome da sala: {sala.NomeDaSala}</h1>
                            </div>
                            <div className="escolheBaralho">
                            ...
                            <div className="botoesEscolheBaralho">
